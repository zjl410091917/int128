...
const addon = require('bindings')('addon');
// const int128 = addon.Int128;
// const int64High =  addon.Int64High;
// const int64High =  addon.Int64Low;
...
class Int128 {
    ...
    toJSON(){
        const ret = {};
        if(this.isSafeNumber){
            ret.safeNumber = this.safeNumber;
        }else{
...
const Plus = function (x, y) {
    ...
    if (x.isPositiveNumber === y.isPositiveNumber) {
        ...
        if (compareRet === COMPARE_STATUS.BIGGER) {
            ...
            const newValue = new addon.Int128(y.value.bottom, y.value.top);
